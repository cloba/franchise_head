...
public class HeadStaff {
	...
	public void setHeadStaffRegitDate(String headStaffRegitDate) {
		this.headStaffRegitDate = headStaffRegitDate;
	}
	public String getHeadStaffResign() {
		return headStaffResign;
	}
