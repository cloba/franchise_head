...
public class Client {
	...
	public String getHeadClientDddr() {
		return headClientDddr;
	}
	public void setHeadClientDddr(String headClientDddr) {
		this.headClientDddr = headClientDddr;
	}
